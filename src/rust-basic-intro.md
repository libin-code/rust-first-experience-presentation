...
<!--
    ...
    It's a joke, C is not terrible like that (maybe)
-->
...
<!--
    ...
    Rust is a mature and excellent programming language.
-->
...
<!--
    ...
    * When writing Stylo, the CSS engine in Firefox, developers were able to replace about 160,000 lines of C++ code with only 85,000 lines of Rust code.
-->
